...
public:
	...
	float GetSpread() { return call_vfunc<float(__thiscall*)(void*)>(this, 446)(this); }
	float GetCone() { return call_vfunc<float(__thiscall*)(void*)>(this, 476)(this); }
	...
	void UpdateAccuracyPenalty() { call_vfunc<void(__thiscall*)(void*)>(this, 477)(this); }
...
//	CNETVAR_FUNC(int, team, "DT_BaseEntity", "m_iTeamNum");
	...
	float& max_speed()
	{
		auto gay = GET_NETVAR("DT_BaseEntity", "m_flMaxspeed");
		return *(float*)((DWORD)this + gay);
	}
	...
	*/
	...
	bool IsPlayer()
	{
		 return call_vfunc<bool(__thiscall*)(void*)>(this, 155)(this); 
		//return GetClientClass()->m_ClassID == (int)CSGOClassID::CCSPlayer;
	}
	bool IsWeapon()
	{
		return call_vfunc<bool(__thiscall*)(void*)>(this, 163)(this);
		//return GetClientClass()->m_ClassID == (int)CSGOClassID::CCSPlayer;
	}
	bool IsMoving()
	{
