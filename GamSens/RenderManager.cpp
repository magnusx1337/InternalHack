...
void Render::Initialise()
{
	...
	Fonts::MenuTextOutline = interfaces::surface->FontCreate();
	...
	interfaces::surface->SetFontGlyphSet(Fonts::Menu, "asdffasdasdsda", 12, 400, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::Text, "DINPro-Regular", 30, 500, 0, 0, FONTFLAG_ANTIALIAS);
	interfaces::surface->SetFontGlyphSet(Fonts::MenuBold, "Tahoma", 12, 500, 0, 0, 0);
	...
	interfaces::surface->SetFontGlyphSet(Fonts::MenuText, "Verdana", 12, 500, 0, 0, FONTFLAG_OUTLINE);
	interfaces::surface->SetFontGlyphSet(Fonts::MenuTextOutline, "Verdana", 12, 500, 0, 0, FONTFLAG_OUTLINE);
	...
	interfaces::surface->SetFontGlyphSet(Fonts::Tabs, "cherryfont", 50, 550, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::IconESP, "icomoon", 14, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::nnbruda, "Verdana", 12, 700, 0, 0, FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::LBY, "Verdana", 27.5, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::niggerbomb, "Verdana", 24, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	interfaces::surface->SetFontGlyphSet(Fonts::CheckBox, "Verdana", 28, 710, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	...
	interfaces::surface->SetFontGlyphSet(Fonts::xd, "Verdana", 38, 710, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
