...
void CCheckBox2::Draw(bool hover)
{
	...
	Render::rect(a.x, a.y, 9, 9, Color(40, 40, 40, 0));
	Render::outlineyeti(a.x, a.y, 9, 9, Color(2, 2, 2, 0));

	if (Checked)
	{
		Render::rect(a.x, a.y, 9, 9, Color(options::menu.ColorsTab.Menu.GetValue(), 0));
		Render::outlineyeti(a.x, a.y, 9, 9, Color(2, 2, 2, 0));
	}
}
...
void CGroupBox::Draw(bool hover)
{
	...
	Render::DrawRect(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(19, 19, 19, 0));
	...
	if (group_tabs.size())
	{
		...
		Render::rect(a.x + 1, a.y + 36, m_iWidth - 1, 1, Color(100, 100, 100, MenuAlpha));
	...
	Render::Text(a.x + (m_iWidth / 2) - (txtSize.right / 2), a.y - (txtSize.bottom / 2) - 1, Color(options::menu.ColorsTab.Menu.GetValue()[0], options::menu.ColorsTab.Menu.GetValue()[1], options::menu.ColorsTab.Menu.GetValue()[2], 0), Render::Fonts::MenuText, Text.c_str());

	Render::Line(a.x, a.y, a.x + (m_iWidth / 2) - (txtSize.right / 2) - 2, a.y, Color(45, 45, 45, 0));
	Render::Line(a.x - 1, a.y - 1, a.x + (m_iWidth / 2) - (txtSize.right / 2) - 1, a.y - 1, Color(0, 0, 0, 0));

	//Top Right
	Render::Line(a.x + (m_iWidth / 2) + (txtSize.right / 2) + 2, a.y, a.x + m_iWidth, a.y, Color(45, 45, 45, 0));
	Render::Line(a.x + (m_iWidth / 2) + (txtSize.right / 2) + 2, a.y - 1, a.x + m_iWidth + 1, a.y - 1, Color(0, 0, 0, 0));

	//Left
	Render::Line(a.x, a.y, a.x, a.y + m_iHeight, Color(45, 45, 45, 0));
	Render::Line(a.x - 1, a.y, a.x - 1, a.y + m_iHeight, Color(0, 0, 0, 0));

	//Bottom
	Render::Line(a.x, a.y + m_iHeight, a.x + m_iWidth, a.y + m_iHeight, Color(45, 45, 45, 0));
	Render::Line(a.x - 1, a.y + m_iHeight + 1, a.x + m_iWidth + 2, a.y + m_iHeight + 1, Color(0, 0, 0, 0));

	//Right
	Render::Line(a.x + m_iWidth, a.y, a.x + m_iWidth, a.y + m_iHeight + 1, Color(45, 45, 45, 0));
	Render::Line(a.x + m_iWidth + 1, a.y, a.x + m_iWidth + 1, a.y + m_iHeight + 1, Color(0, 0, 0, 0));
...
void CKeyBind::Draw(bool hover) // just pasted this out from corruption.vip xd i dont like that skeet wannabe keybind x)
{
	...
	//{
	Render::rect(a.x + 2, a.y + 2, m_iWidth - 4, 17, Color(40, 40, 40, MenuAlpha));
	//}
/*	if (Menu::Window.isOpen())
	{
		if (hover)
...
void CButton::Draw(bool hover)
{
	POINT a = GetAbsolutePos();
	if (hover)
		Render::rect(a.x, a.y, m_iWidth, m_iHeight, Color(55, 55, 55, MenuAlpha));
	else
		Render::rect(a.x, a.y, m_iWidth, m_iHeight, Color(45, 45, 45, MenuAlpha));
