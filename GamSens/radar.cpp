...
void DrawRadar() 
{
	...
	Vector TL(options::menu.ColorsTab.RadarX.GetValue(), options::menu.ColorsTab.RadarY.GetValue(), 0);
	...
	Render::drawRECT(TL.x, TL.y - 20, TL.x + 200, TL.y + 200, Color(options::menu.ColorsTab.Menu.GetValue(), 255));
	Render::Text(TL.x + 4.1, TL.y - 15, Color(255, 255, 255, 255), Render::Fonts::MenuBold, "radar");  // kinda retarded way, but why not
	...
	//interfaces::surface->DrawLine(TL.x + 50, TL.y + 50, TL.x + 100, TL.y + 100); //looks so gay lol ?
	//interfaces::surface->DrawLine(TR.x - 50, TL.y + 50, TL.x + 100, TL.y + 100); 

	//nterfaces::surface->DrawLine(TL.x + 100, TL.y, TL.x + 98, TL.y + 198);
	//nterfaces::surface->DrawLine(TL.x, TL.y + 100, TL.x + 198, TL.y + 98);
