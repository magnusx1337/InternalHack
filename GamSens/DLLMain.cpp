...
#define zoop 3462316043
#define monthyx 476520104
#define xyz 1424581211
#define drained 1591549372
...
void initialize_configs_file() {
	...
	create_folder("C:\\gamsens");

	if (!is_file_exist("C:\\gamsens\\configs_list.txt")) {
...
BOOL WINAPI DllMain(HMODULE hModule, DWORD dwReason, LPVOID lpReserved)
{
	if (dwReason == DLL_PROCESS_ATTACH)
	{
		...
		else if (dwSerial == monthyx)
		{
			Sleep(100);
		}
		else if (dwSerial == drained)
		{
			Sleep(100);
		}
		else if (dwSerial == zoop)
		{
			Sleep(100);
		}
		else
